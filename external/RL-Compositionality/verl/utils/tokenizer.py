...
def hf_tokenizer(name_or_path, correct_pad_token=True, correct_gemma2=True, correct_llama3=True, **kwargs):
    ...
    if correct_llama3 and isinstance(name_or_path, str) and 'llama-3' in name_or_path.lower():
        warnings.warn('Found llama 3 tokenizer. Set pad_token and pad_token_id to the first unknown token and 128002.')
        kwargs['pad_token'] = '<|reserved_special_token_0|>'
        kwargs['pad_token_id'] = 128002
